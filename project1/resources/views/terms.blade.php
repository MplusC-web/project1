...
<div class="col-md-10 col-md-2 mx-auto">
  <div class="card-wrap">
    ...
    <h2>利用規約</h2>
    <p>この利用規約（以下，「本規約」といいます。）は，いいねメモ（https://iinememo.net/）（以下、「当サイト」とします。)で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
    <h3>第1条（適用）</h3>
        <ul>
    ...
    <h3>第2条（利用登録）</h3>
        <ul>
            <li>本サービスにおいては，登録希望者が本規約に同意の上，当サイトの定める方法によって利用登録を申請し，当サイトがこの承認を登録希望者に通知することによって，利用登録が完了するものとします。</li>
    ...
    <h3>第7条（利用制限および登録抹消）</h3>
        <ul>
            <li>当サイトは，ユーザーが以下のいずれかに該当する場合には，事前の通知なく，投稿データを削除し，ユーザーに対して本サービスの全部もしくは一部の利用を制限しまたはユーザーとしての登録を抹消することができるものとします。</li>
            <ul>
    ...
    <h3>第13条（準拠法・裁判管轄）</h3>
        <ul>
            ...
            <li>本サービスに関して紛争が生じた場合には，当サイトの管理者所在地を管轄する裁判所を専属的合意管轄とします</li>
        </ul>
    <p>以上</p>
    </div>
</div>
